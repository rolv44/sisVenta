...
<body id="page1" onload="setInterval('act_pedido()',5000)">
    <div id="header">
        <div class="logo">
        ...
        <div class="container">
            ...
            <div class="usu"><label for=""><?php echo $_SESSION['usuario'];?></label><a href="index.php">Cerrar Sesionx</a></div>
            <ul class="nav">
    ...
    <div id="bcliente">
        <div id="bcliente2">
            ...
            <div class="b"><input type="text" id="bcli" onkeyup="javascript:buscar('bcli','tbl');">
            </div>
            <div class="tablacli">
                <table id="tbl">
                    <tr bgcolor=#80deea>
    ...
    <div id="vemer2">
        <div id="busprod">
            ...
            <div class="b"><input type="text" id="bprodu" onkeyup="javascript:buscar('bprodu','tbl2');">
            </div>
    ...
    <div class="agregpro">
        <form action="php/metodo_listaCarro.php" method="POST">
            ...
            <table class="tblagregar">
                ...
                <tr>
                    ...
                    <td><input type="number" id="numberprod" name="numberprod" required></td>
                    <td><input type="submit" value="AGREGAR" id="btnagrega"></td>
                </tr>
            </table>
        </form>
    </div>
    ...
    <div class="carro_com">
        <table id="tblcarro">
            ...
            <tr>
                ...
                <td style="width:150px"><label for="">NOMBRE</label></td>
                <td style="width:245px"><label for="">DESCRIPCION</label></td>
        ...
        echo"<td><a href='elimina/elim_carrito.php?idcarro=$row[0]&idprod=$row[1]&cant=$row[3]&descr=$row[4]'>Eliminar</a></td>
		</tr>";   
              $contador++;  
             }
            echo "<tr>
