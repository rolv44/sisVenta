...
<body id="page1">
    ...
    <div id="reg1">
        <div id="reg2">
            <div class="lab1">
                <h3>REGISTRAR CLIENTE</h3><input type="button" id="cerrar" value="cerrar" onclick="script:view_add('hidden');"></div>
    ...
    <div id="editar">
        <div id="ven_edit">
            <div class="label_edit">
                <h3>EDITAR CLIENTE</h3><input type="button" id="cerrar" value="cerrar" onclick="script:view_cerrar('hidden');"></div>
