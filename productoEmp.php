...
<head>
    ...
    <link href="estilos/productoEmpstyle.css" rel="stylesheet" type="text/css" />
    ...
    <div class="tblpro">
        ...
        <table class="tblprod" id="datopro" border="1" bordercolor="#80cbc4" cellpadding="0" cellspacing="0">
            <tr bgcolor=#80deea>
                ...
                <th style="width:80px"><label for="">P. C.</label></th>
                <th style="width:80px"><label for="">P. V.</label></th>
                <th style="width:30px"><label for="">STOCK</label></th>
                <th style="width:100px" colspan="3" align="center"><input type="button" value="JR-DISTRIBUIDORES" class="btadd" onclick="view_add('visible');"></th>
                <th></th>
                <th></th>
            </tr>
            <?php
