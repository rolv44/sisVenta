...
if($pago==0){
    ...
    echo "<script type='text/javascript'>window.open('../php/imprimir.php?carro=$idcarro&venta=$vvvv&cliente=$idcliente','IMPRIMIR','width=500,height=700,scrollbars=SI');</script>";
    echo "<script type='text/javascript'>window.location='../ventaEmp.php'; </script>";
    //header("Location:../php/imprimir.php?carro=$idcarro&venta=$idventa&cliente=$idcliente");
